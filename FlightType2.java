...
import static org.airline.model.FlightType1.economySeatCount;

/**
 *
 * @author sanjayp
 */
public class FlightType2 extends Flight{
    ...
    public FlightType2(int ecoSeatCount, int busSeatCount, int firstClsSeatCount, String typeName, int ecoSeatStart, int busSeatStart, int firstClsSeatStart){
