 ...
 * @author sanjayp
 */
public class FlightType3 extends Flight{
    ...
    public FlightType3(int ecoSeatCount, int busSeatCount, int firstClsSeatCount, String typeName, int ecoSeatStart, int busSeatStart, int firstClsSeatStart){
